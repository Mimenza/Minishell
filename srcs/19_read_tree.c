...
// 	if (tree && tree->right && 
//(tree->right->type == 108 || tree->right->type == 110))
// 	{
...
// 	if (tree == NULL)
// 		return ;
// 	//reset_statics(mode, &first_time, &red_to_flag, 
//&red_from_flag, &error_flag, &fd, table_node);
// 	if (mode == 2)
// 	{
// 		first_time = 1;
...
// 	//set_flags(tree, &red_from_flag, &here_doc, 
//&append, &red_to_flag, &error_flag);
// 	if (tree->type == 2)
// 		red_from_flag = 1;
// 	if (tree->type == 3)
// 		here_doc = 1;
...
// 		read_tree(tree->right, table_node, 0);
// 	create_table(tree, table_node);
// 	//set_fds(red_from_flag, red_from_flag, 
//here_doc, append, error_flag, table_node, fd);
